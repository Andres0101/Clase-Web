...
<body>
	...
	<div id="productos">
		...
		<?php
			...
			$catalogo = "SELECT * FROM productos";
			$result = mysqli_query($conexion, $catalogo);
		   	...
		   	while($row = mysqli_fetch_array($result)) {
			   	...
			   	echo "<article>";
					echo "<div class='contenido'";
					    ...
					    //Selecciono el nombre de los productos que están en el catálogo
						...
						while($otheRow = mysqli_fetch_array($resultQuery)) {
							//Obtengo en id de los productos
							$idProducto = $otheRow['idProducto'];
						}
						
						echo "<div class='contenido2'>";							
							echo "<a href='catalogo.php?idProducto=".$idProducto."'>"; //Escribe en la url el id del producto
